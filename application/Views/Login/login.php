...
<html lang="en">
  ...
  <body>
    ...
    usre your caps loc key is off and try again."; }} } else { // Form has not been submitted. if (isset($_GET['logout']) && $_GET['logout'] == 1){
    $message = "Your now logged out."; }  if (!empty($message)) {echo "
    <p>" . $message . "</p>
    ";}?>
